    ...
    return (
      ...
      <div className='test_signup_body'>
          ...
          <div className='upper_part_signip_page'>
                  ...
                  <Input2 value={email} onchange={(e)=>{setemail(e.target.value);change()}} vaild={email_vaild} label={"Email"} messge_err={"You can't leave this field empty"}  placeholder={"Please enter your email"}  type={"email"} pattern="[a-z0-9._%+-]+@[a-z0-9.-]+\.[a-z]{2,4}$" />
